...
import styles from './TibetPanorama.css';
import MoveVideo from '../MoveVideo/moveVideo'
const GeoVis = window.GeoVis;
const Engine = window.Engine;
export default class TibetPanorama extends Component {
    componentWillMount() {
        this.state = {
            isPanorama: false,
            lon: 0,
    ...
    componentDidMount() {
        ...
        const url = 'http://192.168.4.229:28080/beyonserver/beyondb/wms?service=WMS&version=1.1.0&request=GetMap&layers=beyondb:vt_qianjingpoint_c_v01' +
            '&styles=&bbox=97.115479,30.019896,97.268278,30.108056&width=768&height=443&srs=EPSG:4326&format=application%2Fjson%3Btype%3Dgeojson';
