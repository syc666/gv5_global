...
class GlobalSeismic extends Component{
	...
	componentDidMount(){
	    ...
	    //添加全球地震数据
	    this.state.currentObj = new GeoVis.GeoJson('http://192.168.4.229:28080/beyonserver/beyondb/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=beyondb:vt_education_kindergarten_20160810_shp_education_kindergarten_20160810_v01&maxFeatures=3500&outputFormat=application%2Fjson', 
	    	{
	    		markerSize: 6,
