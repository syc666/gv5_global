    ...
    render() {
        return (
            <div>
                ...
                <ThemeDom clickfun={this.clickfun.bind(this)}></ThemeDom>
                <TimeLine isvisible={this.state.isvisible} max={this.state.max} min={this.state.min} value={this.state.value} nowVal={this.state.currentVal} valChange={this.valueChange.bind(this)} actionVal={this.actionValue.bind(this)} ></TimeLine>
