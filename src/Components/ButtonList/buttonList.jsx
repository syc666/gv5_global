    ...
    render() {
        ...
        return (
            <div className={styles["button1"]}>
                <button onClick={this.props.dimensionTab} onMouseUp={this.mouseup.bind(this)} onMouseDown={this.mousedown.bind(this)} onMouseLeave={this.onmouseleave.bind(this)} onMouseEnter={this.onmouseover.bind(this)}>{this.state.value}<img src={this.props.buttonImg} /></button>
    ...
    render() {
        ...
        return (
            <div className={styles["button2"]}>
                <button onClick={this.props.mapTab} onMouseDown={this.mousedown.bind(this)} onMouseLeave={this.onmouseleave.bind(this)} onMouseEnter={this.onmouseover.bind(this)}>{this.props.value}<img src={this.props.buttonImg} /></button>
                <span>{this.state.name}</span>
                <p>{this.state.text}</p>
                {this.state.img}
                {this.state.comp}
        ...
        return (
            <div className={styles["layer"]}>
                ...
                <div className={styles["layer2"]}>
                    <ul>
                        <li><input type="checkbox" id="c1" /><label htmlFor="c1">地名</label></li>
                        <li><input type="checkbox" id="c2" /><label htmlFor="c2">边界</label></li>
                        <li><input type="checkbox" id="c3" /><label htmlFor="c3">国/省界线</label></li>
                        <li><input type="checkbox" id="c4" /><label htmlFor="c4">道路</label></li>
                        <li><input type="checkbox" id="c5" /><label htmlFor="c5">水系</label></li>
                        <li><input type="checkbox" id="c6" /><label htmlFor="c6">3d建筑</label></li>
                        <li><input type="checkbox" id="c7" /><label htmlFor="c7">植被</label></li>
    ...
    render() {
        ...
        return (
            <div className={styles["button3"]}>
                <button onClick={this.props.layerTab} onMouseDown={this.mousedown.bind(this)} onMouseLeave={this.onmouseleave.bind(this)} onMouseEnter={this.onmouseover.bind(this)}>{this.props.value}<img src={this.props.buttonImg} /></button>
                <span>{this.state.name}</span>
                <p>{this.state.text}</p>
                {this.state.img}
                {this.state.comp}
