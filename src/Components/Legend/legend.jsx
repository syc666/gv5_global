    ...
    render(){
        return(
            <div className={styles["PG_legend"]}>
                <div><div style={{backgroundColor: '#13e113'}}></div><span>人口总数&#60;10万</span></div>
                <div><div style={{backgroundColor: '#12d50c'}}></div><span>人口总数10万-100万</span></div>
                <div><div style={{backgroundColor: '#74b486'}}></div><span>人口总数100万-1000万</span></div>
                <div><div style={{backgroundColor: '#f17828'}}></div><span>人口总数1000万-1亿</span></div>
                <div><div style={{backgroundColor: '#cc2700'}}></div><span>人口总数&#62;1亿</span></div>
            </div>
        )
    }
}
     ...
     render(){
         return(
             <div className={styles["CP_legend"]}>
                 <div><div style={{backgroundColor: 'rgb(255,220,0)'}}></div><span>人口总数&#60;12938693</span></div>
                <div><div style={{backgroundColor: 'rgb(255,180,0)'}}></div><span>人口总数12938693-28846170</span></div>
                <div><div style={{backgroundColor: 'rgb(255,150,0)'}}></div><span>人口总数28846170-46023761</span></div>
                <div><div style={{backgroundColor: 'rgb(255,121,0)'}}></div><span>人口总数46023761-65700762</span></div>
                <div><div style={{backgroundColor: 'rgb(255,64,0)'}}></div><span>人口总数65700762-80417528</span></div>
                <div><div style={{backgroundColor: 'rgb(255,32,0)'}}></div><span>人口总数80417528-104320459</span></div>
                <div><div  style={{backgroundColor: 'rgb(255,0, 0)'}}></div><span>人口总数&#62;104320459</span></div>
             </div>
         )
     }
}
